        ...
        <div class="w-full md:w-1/2 flex items-center justify-center bg-white p-6 sm:p-12 overflow-y-auto">
            <div class="w-full max-w-md my-auto">
                ...
                <form action="/register" method="POST" class="space-y-4">
                    ...
                    @if($errors->any())
                    <div class="bg-red-50 border border-red-200 text-red-700 text-sm rounded-md px-3 py-2 space-y-1">
                    ...
                    <div>
                        <label for="nombre" class="block text-sm text-gray-600 mb-1">Nombre del Taller</label>
                        <div class="relative">
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-macuin-blue focus:border-macuin-blue text-sm transition" placeholder="Taller Mecánico Express" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-macuin-blue focus:border-macuin-blue text-sm transition" placeholder="contacto@taller.com" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="tel" id="telefono" name="telefono" value="{{ old('telefono') }}" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-macuin-blue focus:border-macuin-blue text-sm transition" placeholder="+52 (555) 123-4567">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-macuin-blue focus:border-macuin-blue text-sm transition" placeholder="••••••••" required minlength="6">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-macuin-blue focus:border-macuin-blue text-sm transition" placeholder="••••••••" required minlength="6">
                        </div>
                    </div>
